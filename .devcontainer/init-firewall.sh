...
echo "🔒 Initializing Wallestars Firewall Configuration..."
...
if ! curl --connect-timeout 5 https://api.anthropic.com >/dev/null 2>&1; then
    echo "⚠️  WARNING: Unable to reach https://api.anthropic.com"
else
    echo "✅ Anthropic API access verified"
fi

echo "🔒 Wallestars Firewall is active and secure!"
