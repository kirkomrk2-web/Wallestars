...
### 🦎 Чрез Tailscale (Препоръчително за отдалечен достъп)

Tailscale позволява сигурен достъп от всяка точка, без да сте в същата мрежа.

👉 **[Вижте пълното ръководство за Tailscale](TAILSCALE_SETUP_BG.md)**
